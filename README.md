...
| **389** | $x^{11} + 4x - 2$ | $x^{13} + 13x - 2$ | - | - | - |


# Conway Polynomials Database

This repository contains a collection of 108 non-registered **Conway Polynomials** $C_{p,n}$, which are used to define standard extensions of finite fields $GF(p^n)$. These polynomials are essential for ensuring compatibility between different computer algebra systems.
